...
export default function MockTestManager() {
  ...
  return (
    <div className="min-h-screen bg-gray-50/50 dark:bg-background p-6 space-y-6">
      {/* Header */}
      <div className="bg-white dark:bg-card/50 rounded-xl p-6 shadow-sm border border-gray-100 dark:border-border/50">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900 dark:text-foreground">Mock Test Management</h1>
            <p className="text-gray-500 dark:text-muted-foreground">Upload and manage mock tests for practice</p>
          </div>
        </div>
      </div>
                ...
                {!editingId && (
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <label
                        htmlFor="file"
                        className={`cursor-pointer flex items-center justify-center gap-2 border-2 border-dashed border-gray-200 dark:border-border/50 rounded-lg p-4 transition-all ${
                          selectedFile
